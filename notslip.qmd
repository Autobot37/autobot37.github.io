...
const adviceMap = {
  ...
  'medium_low': [
    ...
    "Avoid high‑reward distractions.",
    "Previously boring tasks will be lucrative now but don't get distracted.",
    "boredom, don't add and search other tasks, do more creative sub-tasks from your main tasks or just fucking sit and meditate, don't fidget because it is making you feel uncomfortable which will make uncomfortable tasks Disneyland."
  ],
  'medium_high': [
